...
class UNetEnc1(nn.Module):
    ...
    def __init__(self, in_channels, features, out_channels):
        ...
        self.up = nn.Sequential(
            nn.Conv2d(in_channels, features, 3,  dilation=2),
...
class UNetEnc2(nn.Module):
    ...
    def __init__(self, in_channels, features, out_channels):
        ...
        self.up = nn.Sequential(
            nn.Conv2d(in_channels, features, 3,  dilation=4),
            nn.ReLU(inplace=True),
            nn.Conv2d(features, features, 3),
            nn.ReLU(inplace=True),
            nn.ConvTranspose2d(features, out_channels, 2, stride=2),
...
class UNetEnc3(nn.Module):

    def __init__(self, in_channels, features, out_channels):
        super().__init__()

        self.up = nn.Sequential(
            nn.Conv2d(in_channels, features, 3,  dilation=8),
            nn.ReLU(inplace=True),
            nn.Conv2d(features, features, 3),
            nn.ReLU(inplace=True),
            nn.ConvTranspose2d(features, out_channels, 2, stride=2),
...
class UNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.dec4 = UNetDec(256, 512, dropout=False)
        ...
        self.enc4 = UNetEnc1(1024, 512, 256)
        self.enc3 = UNetEnc2(512, 256, 128)
        self.enc2 = UNetEnc3(256, 128, 64)
