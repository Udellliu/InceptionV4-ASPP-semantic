...
class SegNetEnc(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, num_layers,d):
        super().__init__()

        layers = [
            nn.Upsample(scale_factor=2,mode='bilinear'),
            nn.Conv2d(in_channels, in_channels // 2, 3, padding=1, dilation=d),
...
class SegNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.enc5 = SegNetEnc(512, 512, 1, 2)
        self.enc4 = SegNetEnc(1024, 256, 1, 4)
        self.enc3 = SegNetEnc(512, 128, 1, 8)
        self.enc2 = SegNetEnc(256, 64, 0,1)
