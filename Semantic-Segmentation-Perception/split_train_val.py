...
if __name__ == '__main__':
    ...
    parser.add_argument('--imagepath', default='./data/JPEGImages.txt')
    parser.add_argument('--labelpath', default='./data/gtFine.txt')
    parser.add_argument('--random-state',default=10000)
    parser.add_argument('--train-size',default=0.75)
    parser.add_argument('--val-size',default=0.25)
